...
| [`requirePositive(T value, String context)`](https://rife2.github.io/bld-extensions-tools/rife/bld/extension/tools/ObjectTools.html#requirePositive(T,java.lang.String))                                                              | Returns the value. Throws `NullPointerException` if `label` or `value` is `null`. Throws `IllegalArgumentException` if `value` is zero, negative, or an unsupported type. Supported: `Integer`, `Long`, `Double`, `Float`, `BigInteger`, `BigDecimal`. |
