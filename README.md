...
| [`isEmpty(AbstractMap map)`](https://rife2.github.io/bld-extensions-tools/rife/bld/extension/tools/CollectionUtils.html#isEmpty(java.util.AbstractMap))       | Checks if an abstract map is empty.                   |
| [`isNotEmpty(AbstractMap map)`](https://rife2.github.io/bld-extensions-tools/rife/bld/extension/tools/CollectionUtils.html#isNotEmpty(java.util.AbstractMap)) | Checks if an abstract map is not empty.               |
| [`isEmpty(Hashtable table)`](https://rife2.github.io/bld-extensions-tools/rife/bld/extension/tools/CollectionUtils.html#isEmpty(java.util.Hashtable))         | Checks if a hashtable is empty.                       |
| [`isNotEmpty(Hashtable table)`](https://rife2.github.io/bld-extensions-tools/rife/bld/extension/tools/CollectionUtils.html#isNotEmpty(java.util.Hashtable))   | Checks if a hashtable is not empty.                   |
